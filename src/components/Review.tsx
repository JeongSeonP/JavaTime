...
import { flavorList, richnessList } from "./SelectOptions";
    ...
    <div className="md:w-full max-w-xl w-[350px] ">
      ...
      <div className="flex justify-between items-center px-2">
        <div className="flex items-center">
          {sortList.map((sortItem) => (
            <button
              ...
              className={cx(
                "btn btn-ghost btn-xs  text-xs text-neutral-100 bg-base-300 hover:bg-base-200 hover:text-neutral-500",
                {
                  ["text-secondary-content"]: sortItem === sort,
                }
              )}
            >
              {sortItem === sort ? (
        ...
        <label className="label cursor-pointer">
          <span
            className={cx("label-text font-semibold text-xs mr-1", {
              ["text-neutral-500"]: !filter,
            })}
          >
            포토리뷰만 보기
          </span>
