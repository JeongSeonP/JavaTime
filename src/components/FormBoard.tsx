...
const FormBoard = (props: Contents) => {
  return (
    ...
    <article className="flex-col justify-center mx-auto w-screen lg:w-2/3 md:max-w-3xl py-10 md:px-20 px-10 rounded-3xl border border-base-200 shadow text-base-dark-color mt-10">
